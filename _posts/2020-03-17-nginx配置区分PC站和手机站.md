...
        return   301 [http://kason<wbr>995.com/m$re<wbr>quest_uri](http://kason995.com/m$request_uri);  # 手机版
    }
        if ($mobile_rewrite = do_not_perform) {
        proxy_pass [http://172.1<wbr>68.1.93:8009](http://172.168.1.93:8009/);  # 电脑版
    }
